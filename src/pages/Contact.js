  ...
  return (
    ...
    >
      ...
      <div className="mt-6 sm:mt-8 md:mt-12 text-center">
        <h2 className="text-lg sm:text-xl mb-3 sm:mb-4 animate-glow">
          {t('contactPage.connectWithMe')}
        </h2>
        <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3 md:gap-6">
          {/* <a href="#" className="matrix-button w-full sm:w-auto min-h-[44px] text-base sm:text-lg">GitHub</a> */}
          {/* GitHub link removed as per user request */}
          <a href="#" className="matrix-button w-full sm:w-auto min-h-[44px] text-base sm:text-lg">
            {t('contactPage.linkedinButton')}
          </a>
          <a href="#" className="matrix-button w-full sm:w-auto min-h-[44px] text-base sm:text-lg">
            {t('contactPage.twitterButton')}
          </a>
          <a href="#" className="matrix-button w-full sm:w-auto min-h-[44px] text-base sm:text-lg"> {/* Replace # with your Medium URL */}
            {t('contactPage.mediumButton')}
          </a>
        </div>
      </div>
    </motion.div>
